  ...
  <body>
    <div id="nav-content-wrapper">
      ...
      <div id="content">
        ...
        <main>
          <p>
            For a gentler introduction to some of the odd jobs on this list,
            see the &ldquo;<a
            href="/guides/introduction-to-odd-jobs/">Introduction To Odd
            Jobs</a>&rdquo;.
          </p>
          ...
          <p>
            ...
            builds are <em>always</em> odd (at least, odd enough for
            <b>Oddjobs</b>), but not all such builds are represented here
            (although some are, e.g. HP warriors are statless).
          </p>
          ...
          <div class="table-wrapper">
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td class="align-right">&#x1f34f;&#x1f34f;</td>
                  <td class="align-none">This odd job has enough tricks up its sleeve that it is generally significantly more powerful than a permabeginner of the same level; however, it is still pessimal in comparison to any non-odd job.</td>
                </tr>
                <tr>
                  <td class="align-right">&#x1f34f;&#x1f34f;&#x1f34f;</td>
                  <td class="align-none">This odd job is one of the most powerful odd jobs. It is, at its most well-equipped, capable of performing almost as well as a bad/poor example of a non-odd job. At certain levels, it may even be briefly as powerful as a non-odd job.</td>
                </tr>
              </tbody>
            </table>
          </div>
